...
Я узнал как может изменяться инфляция в игре в зависимости от параметров. Tensorboard очень удобен для отслеживания динамики инляции при разных конфигурациях.
